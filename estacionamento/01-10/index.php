...
<head>
    ...
    <style>
        ...
        .container { width: 350px; margin: 40px auto; background: #fff; border-radius: 7px;
             box-shadow: 0 0 8px #bbb; padding: 20px; }
        label { font-weight: bold; margin-top: 12px; display: block; }
        input, textarea { width: 100%; padding: 5px; border: 1px solid #ccc; border-radius: 4px; }
        button, .switch-btn { margin-top: 15px; padding: 8px 18px; border: none; border-radius: 4px; 
            background: #1b60a6; color: #fff; font-weight: bold; cursor: pointer; }
