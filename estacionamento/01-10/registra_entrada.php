...
try {
    ...
    $stmt2 = $pdo->prepare("INSERT INTO Registro (Placa, hora_entrada, valor_cobrado, observacoes) 
    VALUES (:placa, :hora_entrada, :valor_cobrado, :observacoes)");
    
    // Loga a hora de entrada
    file_put_contents('debug.log', "Hora de Entrada: " . $hora_entrada . "\n", FILE_APPEND);
    
    $stmt2->execute(['placa' => $placa, 'hora_entrada' => $hora_entrada,
     'valor_cobrado' => $valor_cobrado, 'observacoes' => $observacoes]);
